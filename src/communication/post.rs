...
pub trait IPost {
    fn post(&self, sender: &Sender, args: &str) -> Result<(String, String), ()>;

    // to be deleted later:
    fn post_with_cli(&self, sender: &redis::Client, args: &str) -> Result<(String, String), ()>;
}
...
impl IPost for Endpoint {
    ...
    fn post_with_cli(&self, cli: &redis::Client, args: &str) -> Result<(String, String), ()> {
